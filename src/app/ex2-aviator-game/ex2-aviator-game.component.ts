...
@Component({
  selector: 'app-ex2-aviator-game',
  template: `<p>ex2-aviator-game works!</p>
  <div id="aviator-game"></div>
    `,
  styleUrls: ['./ex2-aviator-game.component.css']
})
export class Ex2AviatorGameComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    container = document.getElementById('aviator-game');
